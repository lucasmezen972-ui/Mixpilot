...
private func sample(at timestamp: TimeInterval, rms: Double = -160, peak: Double = -20, available: Bool = true) -> AudioLevelSample {
    AudioLevelSample(timestamp: timestamp, rmsDB: rms, peakDB: peak, sourceAvailable: available)
}
