...
public struct FailureScenarioSuite: Sendable {
    ...
    public static var releaseCandidateScenarios: [FailureScenario] {
        [
            ...
            FailureScenario(name: "Silence audio", incident: .audioSilence, injectionStep: 14, expectedOutcome: .manualControl),
            FailureScenario(name: "Source audio perdue", incident: .audioSourceLost, injectionStep: 16, expectedOutcome: .manualControl),
            FailureScenario(name: "Saturation audio", incident: .audioClipping, injectionStep: 18, expectedOutcome: .recovered),
            FailureScenario(name: "Connexion MIDI perdue", incident: .midiUnavailable, injectionStep: 20, expectedOutcome: .manualControl),
            FailureScenario(name: "Backend DJ fermé", incident: .backendUnavailable, injectionStep: 22, expectedOutcome: .manualControl),
