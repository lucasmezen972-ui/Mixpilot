...
public extension SeratoAction {
    ...
    var mappingInstruction: String {
        isContinuousControl
            ? "Dans Serato, clique sur le contrôle « \(displayName) », puis envoie le message. Vérifie ensuite la réaction du contrôle."
            : "Dans Serato, clique sur la commande « \(displayName) », puis envoie le message MIDI correspondant."
    }
}
